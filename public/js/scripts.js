	...
	$(window).resize(function() {
	    ...
	    $('#doctors .grid').isotope({
	        masonry: {
	            columnWidth: $('#doctors .item').outerWidth()
	        }
	    });
	    ...
	    $('#news .grid').isotope({
	        masonry: {
	            columnWidth: $('#news .item').outerWidth()
	        }
	    });
	    ...
	    $('#photo-tour .grid').isotope({
	        masonry: {
	            columnWidth: $('#photo-tour .item').outerWidth()
	        }
	    });
	});
	...
	$(function() {
	    ...
	    var docs = [{
	        value: 'Dr. Butcher House',
	        data: 'staff-page.html'
	    }, {
	        value: 'Dr. Brick Wall',
	        data: 'staff-page.html'
	    }, {
	        ...
	        value: 'Dr. Mangle Taleebin',
	        data: 'staff-page.html'
	    }, {
	        value: 'Dr. Grim Frog',
	        data: 'staff-page.html'
	    }, {
	        value: 'Dr. Earlene Milone',
	        data: 'staff-page.html'
	    }, {
	        value: 'Dr. Grim Reaper',
	        data: 'staff-page.html'
	    }, {
	        value: 'Dr. Jane Doe',
	        data: 'staff-page.html'
	    ...
	    $('#doctors .grid').isotope({
	        itemSelector: '.item',
	        masonry: {
	            columnWidth: $('#doctors .item').eq(0).outerWidth()
	        }
	    });
